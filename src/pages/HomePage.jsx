      ...
      <section className="bg-gray-100">
        <div className="max-w-6xl mx-auto py-12 px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Veja a simulação de como o desempenho físico da jogadora se traduz
            em engajamento digital, usando os modelos de Cálculo e Estatística.
          </p>
          <NavLink to="/math-analytics">
            <button className="bg-purple-600 text-white py-3 px-8 rounded-full text-lg font-semibold hover:bg-purple-700 transition-colors shadow-lg">
